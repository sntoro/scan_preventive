...
<meta name="viewport" content="width=device-width" />
    ...
    <div class="total-info">
        <div>
            <div class="hire-me">
                <h3 style="letter-spacing:6px;">HISTORICAL REPAIR</h3>
                        ...
                        <tbody>
                            ...
                            <tr>
                               ...
                               <td align="center"><?php echo substr($row->CHR_CREATED_DATE, 6, 2) . '/' . substr($row->CHR_CREATED_DATE, 4, 2 ) . '/' . substr($row->CHR_CREATED_DATE, 0, 4 ); ?></td>
                                ...
                                <td align="center"><a href="<?php echo base_url('index.php/Scan_c/process_repair_v2/'. $row->INT_ID . '/' . $id_type . '/2'); ?>" style="color: #00ffff; text-decoration-line: underline;">View</a></td>
                            </tr>
                            <?php 
                                $no++; 
                                } 
