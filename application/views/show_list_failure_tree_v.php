...
<meta name="viewport" content="width=device-width" />
    ...
    <div>
        <div class="top-menu">
            ...
            <ul>
                ...
                <li><a class="active" href="#">F A I L U R E &nbsp; T R E E</a></li>
    ...
    <div class="total-info">
        <div>
            <div class="hire-me">
                <h3 style="letter-spacing:6px;">FAILURE TREE</h3>
                ...
                <div class="project">
                    <table id="dataTables3" style="color:white;font-size:12px;" class="table table-condensed" cellspacing="0" width="100%">
                        <thead>
                            ...
                            <th style="text-align:center;">FTA Code</th>
                            <th style="text-align:center;">FTA Tree Name</th>
                            <th style="text-align:center;">FTA Type</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center"><a onclick="view_failure(<?php echo $row->INT_ID; ?>)" style="color: #00ffff; text-decoration-line: underline;">View</a></td>
                            </tr>
                            <?php 
                                $no++; 
                                } 
...
<script type="text/javascript">
    function view_failure(id_wi) {
        $.ajax({
            async: false,
            type: "POST",
            url: "<?php echo site_url('Scan_c/view_failure'); ?>",
            data: "id=" + id_wi,
